...
Linux user since 2022. The first Distro i used was Ubuntu Jammy Jellyfish, now i use [CachyOS](https://cachyos.org/) on my Gaming laptop, Windows 11 on ARM Copilot+PC Surface Laptop, and MacOS Ventura 12.7.4 on an old mid-2014 macbook pro.
...
## Tech Stack
[![](https://skillicons.dev/icons?i=python,cpp,html,css,js,github,windows,linux,apple,pycharm,clion,vscode,vim&theme=dark&perline=10)](https://skillicons.dev)

## Currently trying these Programming Languages
[![](https://skillicons.dev/icons?i=java,rust,ruby,go,kotlin&theme=dark&perline=10)](https://skillicons.dev)
